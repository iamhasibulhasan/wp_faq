...
(function () {
  ...
  DEOTHEMES.initialize = {
      ...
      document.addEventListener('keydown', function (e) {
        ...
        if (body.classList.contains('showing-modal')) {
          ...
          if (body.classList.contains('showing-search-modal')) {
            var search = document.querySelectorAll('.arendelle-menu-search');
    ...
    menuSearch: function menuSearch() {
      var search = document.querySelectorAll('.arendelle-menu-search:not(.eversor-menu-search)');
      ...
      var _loop = function _loop() {
        var trigger = search[i].querySelector('.arendelle-menu-search__trigger'),
